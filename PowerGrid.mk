...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)./Dependencies/GLFW/include/GLFW $(IncludeSwitch)./Dependencies/GLAD/include $(IncludeSwitch)./Dependencies/stb-master $(IncludeSwitch)./Dependencies/glm-stable/glm 
IncludePCH             := 
RcIncludePath          := 
...
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)./Dependencies/GLFW/lib-mingw-w64 $(LibraryPathSwitch)./Dependencies/glm-stable/ 
...
$(IntermediateDirectory)/resources_Shape.cpp$(ObjectSuffix): resources/Shape.cpp $(IntermediateDirectory)/resources_Shape.cpp$(DependSuffix)
...
$(IntermediateDirectory)/resources_Shape.cpp$(DependSuffix): resources/Shape.cpp
